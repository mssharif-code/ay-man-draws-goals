...
const SPECS: Spec[] = [
  {
    id: "sunil", name: "Sunil Yadav", role: "Deep Cleaner", city: "Lucknow", state: "Uttar Pradesh",
    ...
    bio: "Sunil handles move-in and festive deep cleans with steam machines and safe chemicals.",
  ...
  {
    id: "harpreet", name: "Harpreet Gill", role: "Driver", city: "Amritsar", state: "Punjab",
    ...
    bio: "Harpreet is a calm, defensive driver with a clean record across city and highway runs.",
  ...
  {
    id: "arjun-e", name: "Arjun Deshmukh", role: "Electrician", city: "Pune", state: "Maharashtra",
  ...
  {
    id: "mahesh", name: "Mahesh Jadhav", role: "Plumber", city: "Nagpur", state: "Maharashtra",
    ...
    bio: "Mahesh solves leaks, blockages and bathroom fittings with minimal breakage.",
  ...
  {
    id: "faisal", name: "Faisal Ahmed", role: "AC Technician", city: "Hyderabad", state: "Telangana",
    ...
    bio: "Faisal services split and window ACs — gas top-ups, installs and annual maintenance.",
  ...
  {
    id: "gopal", name: "Gopal Verma", role: "Carpenter", city: "Jaipur", state: "Rajasthan",
    ...
    bio: "Gopal builds and repairs modular furniture, wardrobes and doors with fine finishing.",
  ...
  {
    id: "ramesh-p", name: "Ramesh Prasad", role: "Painter", city: "Patna", state: "Bihar",
    ...
    bio: "Ramesh does interior and exterior painting with clean masking and dust control.",
  ...
  {
    id: "kartik", name: "Kartik Reddy", role: "Pest Control", city: "Vijayawada", state: "Andhra Pradesh",
    ...
    bio: "Kartik uses child- and pet-safe treatments for cockroaches, termites and mosquitoes.",
  ...
  {
    id: "joseph", name: "Joseph Fernandes", role: "Pool Cleaner", city: "Panaji", state: "Goa",
    ...
    bio: "Joseph maintains villa pools — chemistry balance, filtration and weekly cleaning.",
  ...
  {
    id: "balwant", name: "Balwant Thakur", role: "Security Guard", city: "Shimla", state: "Himachal Pradesh",
    ...
    bio: "Ex-serviceman Balwant handles gate duty, visitor logs and night patrols.",
  ...
  {
    id: "lakshmi", name: "Lakshmi Iyer", role: "Gardener", city: "Chennai", state: "Tamil Nadu",
    ...
    bio: "Lakshmi tends terrace gardens and lawns, from composting to seasonal planting.",
  ...
  {
    id: "pooja", name: "Pooja Chauhan", role: "Laundry Specialist", city: "Indore", state: "Madhya Pradesh",
    ...
    bio: "Pooja handles washing, ironing and delicate fabric care including sarees.",
  ...
  {
    id: "tenzin", name: "Tenzin Bhutia", role: "Pet Care Assistant", city: "Gangtok", state: "Sikkim",
    ...
    bio: "Tenzin walks, feeds and grooms dogs and cats, and handles vet visits.",
